...
const openLightbox = (gallery, i, larges) => {
    ...
    lightboxElement.innerHTML = `
        ...
        <div class="close-modal"><i> <img src="exit.png" alt=""></i></div>
            <figure class="lightbox-container">
                <img src="${larges[i]}" class="lightbox-image">
                <figcaption>
                <nav class="navigation">
                <a href="#" class="lightbox-navigation prev"><i> <img src="flechas.png" alt=""></i></a>
                <a href="#" class="lightbox-navigation next"><i> <img src="flechas.png" alt=""></i></a>
                </nav>
                </figcaption>
            </figure>
        </div>
