    ...
    lightboxElement.innerHTML = `
        ...
        <div class="close-modal"><i class="zmdi zmdi-close"></i></div>
            <figure class="lightbox-container">
                ...
                <a href="#" class="lightbox-navigation prev"><i><img src="logo.png" alt="" class="logo"></i></a>
                <a href="#" class="lightbox-navigation next"><i><img src="logo.png" alt="" class="logo"></i></a>
                </nav>
                </figcaption>
            </figure>
        </div>
